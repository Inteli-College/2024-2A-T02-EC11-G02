...
export default function InitialPage() {
  return (
    <div className={`text-white bg-[url('${Background}')] h-screen w-full`}>
      ...
      <button
        ...
        className="text-white mt-5 hover:text-black border border-whit focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 "
      >
        Acessar relatórios
      </button>
    </div>
